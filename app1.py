...
# sqft = st.number_input("Square Feet", min_value=0, help="Enter the total square feet of the house")
# bath = st.number_input("Number of Bathrooms", min_value=0, help="Enter the number of bathrooms")
# balcony = st.number_input("Number of Balconies", min_value=0, help="Enter the number of balconies")
# size = st.number_input("Size (in BHK)", min_value=0, help="Enter the size in terms of BHK (e.g., 2 for 2BHK)")
